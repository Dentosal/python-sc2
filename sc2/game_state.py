...
class GameState(object):
    def __init__(self, response_observation, game_data):
        ...
        self.psionic_matrix = PsionicMatrix.from_proto(self.observation.raw_data.player.power_sources) # what area pylon covers
        self.game_loop = self.observation.game_loop # game loop, 22.4 per second on faster game speed
        ...
        self.blips = {Blip(unit) for unit in hiddenUnits}
