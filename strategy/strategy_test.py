...
class Strategy_Test(sc2.BotAI):
    ...
    def __init__(self):
        build_order = [
            ...
            (supply_at_least(19), train_unit(UnitTypeId.HELLION, on_building=UnitTypeId.FACTORY)), 
            (supply_at_least(21), train_unit(UnitTypeId.BANSHEE, on_building = UnitTypeId.STARPORT))         
        ]
        self.attack = False
